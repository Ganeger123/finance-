...
const translations = {
    fr: {
        ...
        growth: "Croissance",
        reduced: "Réduit",
        safe_to_spend: "Prêt à Dépenser",
        active: "Actif",
        spent: "Dépensé",
        platform_insights: "Aperçu de la plateforme",
        ...
        user_mgt: "Gest. Utilisateurs",
        system_audit: "Audit du Système",
        active_sessions: "Sessions Actives",
        total_users: "Total Utilisateurs",
        pending_approvals: "Attentes d'Approbation",
        total_volume: "Volume Total",
        recent_activity_log: "Journal d'Activité Récent",
        export_logs: "Exporter Journal",
        status: "Statut",
        details: "Détails",
        ip_address: "Adresse IP",
        expense_saved_title: "Dépense enregistrée",
        expense_saved_body: "Votre nouvelle dépense a été ajoutée avec succès.",
        income_saved_title: "Revenu enregistré",
        income_saved_body: "Votre nouveau revenu a été ajouté avec succès.",
    },
    en: {
        dashboard: "Dashboard",
        expenses: "Expenses",
        ...
        expense_saved_title: "Expense recorded",
        expense_saved_body: "Your new expense has been added successfully.",
        income_saved_title: "Income recorded",
        income_saved_body: "Your new income has been added successfully.",
    },
    ht: {
        ...
        welcome_back: "Byenvini,",
        total_balance: "Balans Total",
        monthly_income: "Revni Mansyèl",
        monthly_expenses: "Depans Mansyèl",
        budget_left: "Bidjè ki Rete",
        growth: "Kwasans",
        reduced: "Redwi",
        safe_to_spend: "Pare pou Depanse",
        active: "Aktif",
        spent: "Depanse",
        platform_insights: "Apèsi Platfòm",
        system_health: "Sante Sistèm",
        optimal: "Optimal",
        activity: "Aktivite",
        upcoming_bills: "Bòdwo k ap Vini",
        see_all: "Wè tout",
        add_reminder: "Ajoute Rapèl",
        admin_control: "Kontwòl Admin",
        admin_console: "Konsol Admin",
        user_mgt: "Jeryen Itilizatè",
        system_audit: "Audit Sistèm",
        active_sessions: "Sesyon Aktif",
        total_users: "Total Itilizatè",
        pending_approvals: "Ap tann Apwobasyon",
        total_volume: "Volim Total",
        recent_activity_log: "Journal Aktivite Resan",
        export_logs: "Ekspòte Journal",
        status: "Statut",
        details: "Detay",
        ip_address: "Adrès IP",
        expense_saved_title: "Depans anrejistre",
        expense_saved_body: "Nouvo depans ou a ajoute avèk siksè.",
        income_saved_title: "Revenn anrejistre",
        income_saved_body: "Nouvo revenn ou a ajoute avèk siksè.",
    }
};
...
export const LanguageProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
    const [language, setLanguageState] = useState<Language>(() => {
        try {
            ...
            return (saved === 'fr' || saved === 'en' || saved === 'ht' ? saved : 'fr') as Language;
        } catch {
            return 'fr';
        }
    });
